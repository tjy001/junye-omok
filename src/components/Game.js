        ...
        if (copy.isConfirmed) {
          try {
            ...
            Swal.fire({
              ...
              html: `Please copy the Game ID Manually:
                <br><input type="text" value="${gameid}" readonly="readonly" style="text-align: center; width: 6em;">
                <br>Alternatively, you may find the Game ID in the URL.`,
            });
          }
        }
      });
